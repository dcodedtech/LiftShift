      ...
      <div className="space-y-7">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-300 leading-relaxed">
            ...
            <li><strong className="text-white">Per-muscle volume</strong> \u2014 How volume is distributed across muscle groups (visible on the <a href={assetPath('metrics/muscle-heatmap/')} className="text-emerald-300 underline">muscle heatmap</a>).</li>
          ...
          <p className="text-slate-300 leading-relaxed mb-4">
            A steadily rising weekly volume often indicates progressive overload (you\u2019re doing more work over time). A sharp drop may be intentional (a deload week) or a sign of inconsistency. Look at volume alongside other metrics like <a href={assetPath('metrics/personal-records/')} className="text-emerald-300 underline">PRs</a> and <a href={assetPath('metrics/one-rep-max/')} className="text-emerald-300 underline">1RM estimates</a> for a complete picture.
          </p>
        </section>
