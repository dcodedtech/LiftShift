      ...
      <div className="space-y-7">
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-300 leading-relaxed">
            <li><a href={assetPath('supported-apps/hevy/')} className="text-slate-400 hover:text-emerald-300 hover:underline transition-all duration-200">Hevy</a> \u2014 CSV import and API sync</li>
            <li><a href={assetPath('supported-apps/strong/')} className="text-slate-400 hover:text-emerald-300 hover:underline transition-all duration-200">Strong</a> \u2014 CSV import</li>
            <li><a href={assetPath('supported-apps/lyfta/')} className="text-slate-400 hover:text-emerald-300 hover:underline transition-all duration-200">Lyfta</a> \u2014 CSV import and API sync</li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-white mb-3">What LiftShift needs from exports</h2>
